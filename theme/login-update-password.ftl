...
<div class="d-flex flex-row align-items-center h-75 gap-5">
  ...
  <div class="d-flex flex-column align-items-center p-5 bg-white gap-3" style="border-radius: 1.5rem;position: relative;">
    ...
    <form onsubmit="return true;" action="${url.loginAction}" method="post">
      <div class="mb-3">
        <label for="password-new" class="form-label small">Password</label>
        <div class="input-group">
          <input tabindex="0" required id="password-new" class="form-control py-2" name="password-new" type="password" autoComplete="new-password">
          <i class="bi bi-key input-group-text"></i>
        </div>
      </div>
      <div class="mb-5">
        <label for="password-confirm" class="form-label small">Password</label>
        <div class="input-group">
          <input tabindex="0" required id="password-confirm" class="form-control py-2" name="password-confirm" type="password" autoComplete="new-password">
          <i class="bi bi-key input-group-text"></i>
        </div>
      </div>
